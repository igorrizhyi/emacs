                     ...
                     (properties . ((tasks . ((type . "array")
                                              (items . ((type . "object")
                                                        (properties . ((role . ((type . "string")
                                                                       ...
                                                                       (target . ((type . "string")
                                                                                  (description . "Buffer name or worktree name of a specific agent to assign this task to")))
                                                                       (model . ((type . "string")
                                                                                 (description . "Model override for the spawned agent (e.g. \"gemini-2.5-flash-lite\"). When set, a new agent is spawned with this model instead of the role default.")))))
